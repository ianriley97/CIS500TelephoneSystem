...
namespace DTS_Project
{
    public class TerminalDevice: ITerminalDevice
    {
        ...
        public void ShowMainMenuDialog(TerminalController terminalController)
        {
            MainMenuDialog mainMenuDialog = new MainMenuDialog(terminalController);
            mainMenuDialog.Show();
        }

        public void ShowTenantMenuDialog(TerminalController terminalController)
        {
        ...
        public bool GetPassword(ref string password)
        {
            ...
            if (passwordDialog.ShowDialog() != DialogResult.OK) return false;
